  ...
  return (
    <main className="min-h-screen bg-[#8b0000] flex justify-center overflow-x-hidden">
      {/* 
          ...
          Native ESM compatible structure.
      */}
        ...
        >
          ...
          <div className="relative px-6 pb-12 pointer-events-auto">
            ...
            >
              ...
              <div className="absolute inset-0 bg-white/20 translate-x-[-150%] skew-x-12 group-hover:translate-x-[150%] transition-transform duration-1000"></div>
            </button>
          </div>
        </div>
