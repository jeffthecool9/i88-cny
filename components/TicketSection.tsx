      ...
      <div className="px-6 max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TICKET_TIERS.map((tier, idx) => (
            <div 
              key={idx} 
              className="relative bg-[#000814] p-12 rounded-[2.5rem] border-2 border-[#eab308]/20 flex flex-col items-center text-center shadow-[0_20px_40px_rgba(0,0,0,0.6)] group hover:border-[#eab308]/60 transition-all hover:scale-[1.03]"
            >
              {/* Badge */}
              ...
              {/* Deposit Label */}
              <div className="text-[#ef4444] text-[10px] font-black uppercase tracking-[0.3em] mb-2">
                Deposit
              </div>
              ...
              {/* Tickets Count */}
              <div className="text-[#eab308] text-7xl font-black mb-1 drop-shadow-[0_0_25px_rgba(234,179,8,0.4)]">
                {tier.tickets}
              </div>
              <div className="text-white/40 text-xs font-black uppercase tracking-[0.4em] mb-12">
                Tickets
              </div>

              {/* Pre-event only notice for RM500 */}
              {tier.isPreEvent && (
                <div className="absolute top-4 right-4 bg-[#8b0000] text-[#eab308] text-[9px] font-black px-3 py-1 rounded-full border border-[#eab308]/40 uppercase animate-pulse">
                  Pre-event
                </div>
              )}
