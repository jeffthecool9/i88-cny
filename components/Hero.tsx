...
// ✅ VITE ASSET IMPORT (THIS IS THE KEY)
  ...
  return (
    <section className="relative h-screen min-h-[750px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6">
        <h1 className="text-7xl md:text-[10rem] font-black mb-4 cny-title-glow">
          八仙过海
        </h1>

        <p className="text-white text-lg md:text-3xl font-bold mb-10 tracking-[0.2em] uppercase">
          Collect Weapons • Unlock Rewards • Grab the Grand Prize
        </p>

        <div className="bg-[#8B6E0D]/95 border-2 border-[#ffcc00] text-white px-10 py-3 rounded-full font-black text-sm md:text-xl shadow-2xl">
