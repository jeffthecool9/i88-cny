...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      // Subtle parallax calculation for high-end cinematic immersion
...
<div className="absolute inset-0 z-0">
  ...
  <div className="absolute inset-0 shadow-[inset_0_0_180px_rgba(0,0,0,0.85)]" />
      ...
      {/* 5. DIVINE GOLDEN PARTICLES (Dopamine Micro-interactions) */}
      ...
      <div className="relative z-40 flex flex-col items-center text-center px-6 w-full max-w-4xl pt-10">
        ...
        <div className="mb-6 animate-float">
          <div className="w-36 h-36 md:w-48 md:h-48 rounded-full border-[6px] border-[#ffcc00] shadow-[0_0_60px_rgba(255,204,0,0.8)] overflow-hidden bg-gradient-to-b from-[#8B0000] to-black relative">
            ...
            />
            <div className="absolute inset-0 shadow-[inset_0_0_30px_rgba(255,215,0,0.4)]"></div>
          </div>
        </div>
        
        {/* Event Title (CNY Aesthetic with Golden Glow) */}
        <h1 className="text-7xl md:text-[10rem] font-black mb-2 cny-title-glow tracking-tighter leading-none select-none drop-shadow-[0_0_30px_rgba(255,215,0,0.4)]">
          八仙过海
        </h1>
      ...
      {/* 7. EVENT MARQUEE TICKER (Anchors the UI) */}
      <div className="absolute bottom-0 w-full bg-gradient-to-r from-[#8B6E0D] via-[#FFD700] to-[#8B6E0D] text-[#2a0101] py-4 font-black text-xs md:text-base uppercase z-50 shadow-[0_-15px_40px_rgba(0,0,0,0.9)] border-t border-yellow-300/40">
